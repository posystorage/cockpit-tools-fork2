...
mod tests {
    ...
    #[test]
    fn sub2api_usage_candidates_include_v1_fallback_for_root_url() {
        assert_eq!(
            codex_model_provider_usage_url_candidates("https://example.com").unwrap(),
            vec![
                "https://example.com/usage".to_string(),
                "https://example.com/v1/usage".to_string(),
            ]
        );
        assert_eq!(
            codex_model_provider_usage_url_candidates("https://example.com/api").unwrap(),
            vec!["https://example.com/api/usage".to_string()]
        );
    }
