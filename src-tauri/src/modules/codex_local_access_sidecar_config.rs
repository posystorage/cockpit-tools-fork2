...
struct SidecarAuthSelectedEvent {
    ...
    #[serde(default)] account_email: String,
    #[serde(default)] api_key_id: String,
    #[serde(default)] api_key_label: String,
    #[serde(default)] model: String,
    #[serde(default)] request_kind: String,
    #[serde(default)] routing_strategy: String,
}
