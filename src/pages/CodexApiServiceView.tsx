            ...
            <div className="codex-api-service-title-row">
              ...
              <div className="codex-api-service-title-copy">
                <div className="codex-api-service-title-line">
                  ...
                  <span
                    className={`codex-api-service-status ${!collection?.enabled ? "disabled" : state?.running ? "running" : "stopped"}`}
                  >
                    {collection?.enabled
                      ? state?.preparing
                      ...
                      >
                        ...
                        <div className="codex-api-service-account-meta">
                          ...
                          {activity && activity.runningCount > 0 ? (
                            <span className="codex-api-service-account-activity is-running"><Activity size={12} />{t("codex.apiService.accountActivity.running", { count: activity.runningCount, defaultValue: "调度中 {{count}}" })}</span>
                          ) : null}
                          <span>
                            {t("codex.apiService.accountHealth.failures", {
                              count: health?.consecutiveFailures ?? 0,
